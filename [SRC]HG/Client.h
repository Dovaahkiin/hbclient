...
public:
	...
	DWORD m_dwTime, m_dwHPTime, m_dwMPTime, m_dwSPTime, m_dwAutoSaveTime, dwTime, m_dwHungerTime;
...
int m_cLU_Str, m_cLU_Vit, m_cLU_Dex, m_cLU_Int, m_cLU_Mag, m_cLU_Char;
	...
	BOOL m_bIsOnCombatantZone; // v3.2
	...
	int  m_iDeaths, m_iDGDeaths, m_iDGKills, m_iTotalDGDeaths, m_iTotalDGKills; // MORLA 2.2 - Nuevos datos
};
