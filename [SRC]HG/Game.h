...
#define DEF_AUTOSAVETIME		600000	// 자동 저장 시간간격 30분 
...
//============================
	...
	#define DEF_PLAYERMAXLEVEL	200			// 최대 레벨: Npc.cfg 파일에 설정되어 있지 않을 경우 m_iPlayerMaxLevel에 입력된다.
#else
	#define DEF_PLAYERMAXLEVEL	200				// 최대 레벨: Npc.cfg 파일에 설정되어 있지 않을 경우 m_iPlayerMaxLevel에 입력된다.
...
#define DEF_MAXCONSTRUCTIONPOINT 50000		// 최대 소환 포인트 
...
#define DEF_MAXGIZONPOINT		999			// adamas : 최고 지존 업그레이드
