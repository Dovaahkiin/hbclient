...
//NetPanel
#define DEF_SPRID_INTERFACE_ND_ICONPANNEL2	80
#define DEF_SPRID_INTERFACE_NETPANEL		81
#define DEF_SPRID_INTERFACE_NETPANELBUTTONS	82
#define DEF_SPRID_INTERFACE_ND_PARTYSTATUS	83